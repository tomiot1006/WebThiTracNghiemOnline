...
/**
 * Servlet implementation class ThemNTDT
 */
@WebServlet("/ThemNTDT")
public class ThemNTDT extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/ThemNTDT.jsp").forward(request, response);
	}
