...
<body>
                    ...
                    <li>
                		<a href="#" class="dropdown-toggle" data-toggle="dropdown">QUẢN LÝ NGÂN HÀNG CÂU HỎI<b class="caret"></b></a>
                         ...
                         <c:forEach items="${DSMonHoc}" var="monhocdemo">
                    			<li><a href="NHCauHoiGiangVien.jsp?MaMH=${monhocdemo.getMaMH()}"><span>${monhocdemo.getTenMH()}</span></a></li>
                    			<li class="divider"></li>
                   			</c:forEach>
                         </ul>
                    </li>
                     ...
                     <li>
                		...
                		<a href="#" class="dropdown-toggle" data-toggle="dropdown">TẠO DANH SÁCH CÂU HỎI<b class="caret"></b></a>
                         <ul class="dropdown-menu">
                        	<c:forEach items="${DSMonHoc}" var="monhocdemo">
                    			<li><a href="TaoCauHoiGiangVienOL.jsp?MaMH=${monhocdemo.getMaMH()}"><span>${monhocdemo.getTenMH()}</span></a></li>
                    			<li class="divider"></li>
                   			</c:forEach>
    ...
    <div class="col-md-2 menu-left menuleft" style="width:auto;">
        <ul class="main-menuleft">
            ...
            <li><a href="./ThongTinGiangVien" name="clickme" id="idThongTinGiangVien" ><i class="glyphicon glyphicon-user" style="padding:15px;"></i>Thông Tin Cá Nhân</a></li>
