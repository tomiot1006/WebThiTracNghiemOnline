...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="ThemSV" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" style="width: 300px;" name="khoa">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					Nam<br> <input type="radio" name="gioitinh" value="nu">
					Nữ <br>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="text">Link Image
					:</label>
				<div class="col-sm-10">
					<input type='file' name="txtPhoto" onchange="readURL(this);"
						id="myFile" accept="image/gif, image/jpeg, image/png" /> <br>
